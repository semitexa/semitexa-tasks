...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-tasks/security/advisories/new).
...
In scope: anything in `semitexa/tasks` that lets a request, a job or a message do
